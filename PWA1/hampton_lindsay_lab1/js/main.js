/*
     ...
     Date: May the Fourth be with you, 2015.
     Class & Section:  PWA1-244
...
var myArray = [];
myArray.push("baseball");
myArray.push("football");
myArray.push("basketball");
...
if(weather == "sunny" && waves == 10) {
    ...
    bobsMood = "mellow";
} else if(weather == "sunny" && waves > 10 || waves < 5){
    bobsMood ="bummed"
} else if (weather == "overcast" && waves >= 7 || waves <= 10){
    bobsMood = "jackedUp";
} else if (weather == "overcast" && waves >=3 || waves <=6){
    bobsMood = "totally bummed";
} else if (weather = "overcast" && waves > 10 || waves < 3){
    bobsMood = "not happy";
} else {
    bobsMood = "sad";
}
...
console.log("Student 1 is feeling "+student1+".");
...
function moodFunction (weather,waves){
    if (weather == "Sunny") {
        if (waves = 10) {
            bobsMood = "Pumped";
...
console.log (moodFunction(value1, value2));
